      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-5">
            ...
            <p className="text-[#a09080] leading-relaxed max-w-sm mb-6 text-sm">
              {t("tagline")}
            </p>
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-[#c9a86c] hover:bg-[#c9a86c]/10 transition-all"
              >
                <Facebook size={16} className="text-[#c9a86c]" />
              </a>
              <a
                ...
                className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-[#c9a86c] hover:bg-[#c9a86c]/10 transition-all"
              >
                <Instagram size={16} className="text-[#c9a86c]" />
              </a>
            </div>
          </div>

          <div className="lg:col-span-2">
            <h4 className="text-xs font-bold tracking-[0.25em] text-[#c9a86c] uppercase mb-4">
              {t("explore")}
            </h4>
            <ul className="space-y-2">
              {navItems.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-[#a09080] hover:text-white transition-colors text-sm"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2 text-[#a09080] text-sm">
              <li>{t("phone")}</li>
              <li>{t("email")}</li>
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[#a09080] leading-relaxed text-sm">
              {t("season")}
            </p>
          </div>
        </div>
