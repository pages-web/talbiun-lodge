            ...
            >
              <Link href={`/accommodation/${ger.id}`} className="block">
                ...
                <div className="p-4">
                  ...
                  <p className="text-[#6b5e52] mb-3 leading-relaxed text-sm line-clamp-1">{t(`${ger.key}.description`)}</p>

                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {ger.amenities.map((amenity) => (
                      <span
                        key={amenity}
                        className="px-2 py-0.5 bg-white text-[#4a3f36] text-xs tracking-wide"
                      >
                        {amenity}
                      </span>
                    ))}
