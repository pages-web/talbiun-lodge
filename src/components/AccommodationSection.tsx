...
export default function AccommodationSection() {
  ...
  return (
    <section ref={ref} className="h-[calc(100vh-4rem)] min-h-[calc(100vh-4rem)] snap-start flex items-center justify-center bg-[#efe9df] py-4 lg:py-0">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-2 mb-4">
          <div className="max-w-2xl">
            <motion.p
              ...
              className="text-[10px] tracking-[0.35em] text-[#7a5e12] uppercase mb-1 font-medium"
            >
              {t("subtitle")}
            </motion.p>
            <motion.h2
              ...
              className="text-xl md:text-2xl lg:text-3xl font-serif text-[#1f1a17] leading-[1.1] mb-1"
            >
              {t("title")}
            </motion.h2>
            <motion.p
              ...
              className="text-[#6b5e52] leading-relaxed text-xs line-clamp-1"
            >
              {t("description")}
            </motion.p>
          </div>
            ...
            >
              <Link href={`/accommodation/${ger.id}`} className="block">
                <div className="relative aspect-[16/7] overflow-hidden">
                  ...
                  />
                  <div className="absolute top-2 right-2 bg-white/95 backdrop-blur-sm text-[#1f1a17] px-2 py-1 font-serif text-sm">
                    {t(`${ger.key}.price`)}
                    <span className="text-[10px] font-sans font-normal text-[#6b5e52] ml-1">/{t("price")}</span>
                  </div>
                </div>
                ...
                <div className="p-3">
                  ...
                  <p className="text-[#6b5e52] mb-2 leading-relaxed text-xs line-clamp-1">{t(`${ger.key}.description`)}</p>

                  <div className="flex flex-wrap gap-1 mb-2">
                    {ger.amenities.map((amenity) => (
                      <span
                        key={amenity}
                        className="px-1.5 py-0.5 bg-white text-[#4a3f36] text-[9px] tracking-wide"
                      >
                        {amenity}
                      </span>
                    ))}
