      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">{t(`${id}.name`)}</h1>
              <p className="text-slate-400">{t(`${id}.description`)}</p>
            </div>
            ...
            <div className="bg-[#1e3a5f]/30 rounded-xl p-6 border border-[#2d5a7b]/30">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-3xl font-bold text-[#3b82f6]">{t(`${id}.price`)}</span>
              </div>
